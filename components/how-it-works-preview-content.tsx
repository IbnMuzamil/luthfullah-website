...
export function HowItWorksPreviewContent({ data }: { data: any }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-teal/10 rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-6xl mx-auto">
                ...
                >
                  ...
                  <div className="space-y-3 md:space-y-4 relative z-10">
                    <div className="flex items-start justify-between">
                      <div className={`w-12 h-12 md:w-14 md:h-14 rounded-lg bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                        <Icon className="w-6 h-6 md:w-7 md:h-7 text-white" />
                      </div>
                      <span className={`text-3xl md:text-4xl font-bold bg-gradient-to-br ${step.color} bg-clip-text text-transparent opacity-30`}>
                        {step.number}
                      </span>
                    </div>
          ...
          <div className="text-center">
            <Button size="lg" className="text-base md:text-lg px-6 md:px-8 py-5 md:py-6 border-2 group bg-gradient-to-r from-primary to-teal text-white hover:shadow-xl hover:shadow-primary/30 transition-all duration-300" asChild>
