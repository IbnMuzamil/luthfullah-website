...
export function StartProjectContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.email || !formData.projectType || !formData.description || !formData.budget) {
      alert('Please fill in all required fields (Name, Email, Project Type, Budget, and Description)')
      return
    }
    ...
    try {
      ...
      if (res.ok) {
        alert('✓ Thank you! Your project request has been received. We will contact you at ' + formData.email + ' within 24-48 hours.')
        setFormData({
          name: "",
          email: "",
          phone: "",
